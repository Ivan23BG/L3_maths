...
\begin{definition}
    ...
    On dit que \(f\) est \defemph{\(\alpha\)-Hölderienne} si
    pour tout \(x, y \in X\),
    \begin{equation*}
...
\begin{remark}
    Si \(\alpha = 1\), on dit que \(f\) est \defemph{Lipschitzienne}.
\end{remark}
...
\begin{definition}
    Soit \(A\sub X\). On appelle \defemph{topologie induite} sur \(A\) (par \(X\))
    la topologie
    \begin{equation*}
