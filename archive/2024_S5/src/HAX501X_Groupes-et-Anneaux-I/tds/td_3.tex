...
\begin{td-exo}[Centre du groupe diédral] % 14
    Déterminer le centre du groupe diéedral \(D_n\), pour \(n\in \bb N^*\).
\end{td-exo}

\iftoggle{showsolutions}{
    \begin{td-sol}[]\, % 14

        \ptr{} Pour \(n\leq 2\), le groupe \(D_n\) est abélien donc 
        \begin{equation*}
            Z(D_n) = D_n
        \end{equation*}

        \ptr{} Pour \(n\geq 3\), on a
        \begin{equation*}
            \begin{aligned}
                r^k s = s r^{-k}
            \end{aligned}
        \end{equation*}
        pour tout \(k\in\{0,\ldots,n-1\}\).

        \ptr{} Soit \(r\) une rotation. Alors, pour tout \(k\in\{0,\ldots,n-1\}\), on a
        \begin{equation*}
            r^k s = s r^{-k}
        \end{equation*}
        Donc pour que \(r\in Z(D_n)\), il faut que \(r\) soit une rotation telle que \(r^k = r^{-k}\) pour tout \(k\in\{0,\ldots,n-1\}\).
        Alors, \(r\) est une rotation d'angle \(0\) ou \(\pi\).

        \ptr{} Avec les notations du cours, on peut montrer qu'aucune réflexion n'est dans le centre de \(D_n\).\\
        Par exemple, on montre que pour \(k\in \{0,\ldots,n-1\}\), on a \(r^k s\) qui ne commute
        pas avec \(r\).
        \begin{equation*}
            \begin{aligned}
        ...
        \begin{equation*}
            \begin{aligned}
                Z(D_n) = \{\id, r^{\frac{n}2}\},\quad n\text{ pair},\\
                Z(D_n) = \{\id\},\quad n\text{ impair}.
            \end{aligned}
        \end{equation*}
    \end{td-sol}
}{}